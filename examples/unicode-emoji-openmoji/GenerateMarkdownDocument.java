...
public class UnicodeMarkdownTable {
    public static void main(String[] args) {
        ...
        output.append("""
                ---
                title: "Unicode Emoji with OpenMoji"
                ...
                # Unicode Emoji with *OpenMoji*
                
                This example document demonstrates the usage of emoji characters that should be displayed with the
                font *OpenMoji*. The Font *Noto Sans* is used as the main font with the variable `mainfont` but
                lacks emoji characters. Missing characters are provided by *OpenMoji* as fallback font with
